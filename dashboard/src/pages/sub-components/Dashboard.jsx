...
const Dashboard = () => {
  ...
  const VisiPortfolio = ()=>{
    window.open('https://shivanportfolio123.netlify.app/', '_blank');
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              ...
              <Card className="sm:col-span-2">
                <CardHeader className="pb-3">
                  <CardDescription className="max-w-lg text-balance leading-relaxed text-black">
                    {user.aboutMe}
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                  <Button className="bg-blue-700 hover:bg-blue-900" onClick={VisiPortfolio}>Visit Portfolio</Button>
                </CardFooter>
              </Card>
              ...
              <Card className="flex flex-col justify-center">
                ...
                <CardFooter>
                  <Button className="bg-blue-700 hover:bg-blue-900" onClick={gotoMangeProjects}>Manage Projects</Button>
                </CardFooter>
              </Card>
              ...
              <Card className="flex flex-col justify-center">
                ...
                <CardFooter>
                  <Button className="bg-blue-700 hover:bg-blue-900" onClick={gotoMangeSkills}>Manage Skill</Button>
                </CardFooter>
              </Card>
                              ...
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell className="md:table-cell">
                                  <Link to={`/update/project/${element._id}`}>
                                    <Button className="bg-blue-700 hover:bg-blue-900">Update</Button>
                                  </Link>
                                </TableCell>


                                <TableCell className="hidden md:table-cell text-right hover:underline hover:text-blue-500">
                                  <Link
                                    className="text-xs "
                                    variant="secondary"
                                    to={element.deployed}
              ...
              <TabsContent className="grid min-[1050px]:grid-cols-2 gap-4">
                ...
                <Card>
                  <CardHeader className="px-7 flex items-center justify-between flex-row">
                    ...
                    <Button  onClick={gotoMangeTimeline} className="w-fit bg-blue-700 hover:bg-blue-900">
                      Manage Timeline
                    </Button>
                  </CardHeader>
                  <CardContent>
