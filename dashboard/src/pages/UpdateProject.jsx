        ...
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <div className="flex flex-col gap-2 items-start justify-between sm:items-center sm:flex-row">
                ...
                <Button className="bg-blue-700 hover:bg-blue-900" onClick={handleReturnToDashboard}>
                  Return to Dashboard
                </Button>
              </div>
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            {loading ? (
              ...
              <button
                type="submit"
                className="rounded-md bg-blue-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-52"
              >
                Update
              </button>
            )}
