...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(
      "https://mern-stack-portfolio-backend-bf3p.onrender.com/api/v1/user/forgot/password",
      { email },
  ...
  (token, password, confirmPassword) => async (dispatch) => {
    try {
      ...
      const response = await axios.put(
        `https://mern-stack-portfolio-backend-bf3p.onrender.com/api/v1/user/password/reset/${token}`,
